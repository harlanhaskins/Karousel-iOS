...
public extension UIImageView {
    ...
    public func hnk_setImageFromURL(URL: NSURL, key: String, placeholder : UIImage? = nil, format : Format<UIImage>? = nil, failure fail : ((NSError?) -> ())? = nil, success succeed : ((UIImage) -> ())? = nil) {
